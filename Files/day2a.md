...
From these probabilities we will calculate the population branch statistic (PBS) using the PEL as target population and LWK and TSI as reference populations.
