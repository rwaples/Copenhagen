...
Note that in these VCF alleles have been polarised according to the reference sequence, and not the ancestral one!
...
This exercise stresses the importance of knowing that the reference sequence is just an arbitrary choice of alleles and should NOT be used for evolutionary unferences.
